...
import cr.ac.ucr.eii.data.role.RoleAdministrador;
import cr.ac.ucr.eii.ui.EstadoEdicion;
import cr.ac.ucr.eii.ui.IControlEditor;
import javax.swing.JOptionPane;

public class RoleEditor extends javax.swing.JFrame implements IControlEditor {
...
//        control.registrarVentana(this);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(" Datos del role "));
...
//        role.setCodigo(txtCodigo.getText());
        role.setNombre(txtNombre.getText());
    }


    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        RoleAdministrador administrador = new RoleAdministrador();
        cargarDatos();
        ...
        if (n == 0) {
            switch (estado) {
                case AGREGAR:
                    administrador.registrar(role);
                    break;
                case MODIFICAR:
                    administrador.actualizar(role);
                    break;
                case ELIMINAR:
                    administrador.eliminar(role);
                    break;
            }
        }
