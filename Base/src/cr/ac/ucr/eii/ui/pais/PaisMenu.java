...
public class PaisMenu extends javax.swing.JFrame implements ReceptorBusqueda {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(750, 147));
...
//        if (n == 0) {
            PaisEditor editor = new PaisEditor();
...
//                options[0]); //default button title
//        if (n == 0) {
            PaisBuscador buscador = new PaisBuscador();
    ...
    public void recibirResultadoBusqueda(IDato dato, String mensaje) {
        ...
        switch (estado) {
            case AGREGAR:
                ...
                editor.establecerEstado(EstadoEdicion.AGREGAR);
                editor.setPais(new Pais());
                break;
            case MODIFICAR:

                editor.establecerEstado(EstadoEdicion.MODIFICAR);
                editor.setPais((Pais) dato);
                break;
            case ELIMINAR:
