...
public class UsuarioMenu extends javax.swing.JFrame implements ReceptorBusqueda {
...
//                options[0]); //default button title
//        if (n == 0) {
            UsuarioBuscador buscador = new UsuarioBuscador();
    ...
    public void recibirResultadoBusqueda(IDato dato, String mensaje) {
        ...
        switch (estado) {
            case AGREGAR:
                ...
                editor.establecerEstado(EstadoEdicion.AGREGAR);
                editor.setDato(new Usuario());
                break;
            case MODIFICAR:

                editor.establecerEstado(EstadoEdicion.MODIFICAR);
                editor.setDato((Usuario) dato);
                break;
            case ELIMINAR:
