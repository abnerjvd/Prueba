 ...
 * under the License.
 */
package cr.ac.ucr.eii.ui.canton;
...
public class CantonMenu extends javax.swing.JFrame implements ReceptorBusqueda {
...
//        if (n == 0) {
            CantonEditor editor = new CantonEditor();
...
//                options[0]); //default button title
//        if (n == 0) {
            CantonBuscador buscador = new CantonBuscador();
    ...
    public void recibirResultadoBusqueda(IDato dato, String mensaje) {
        ...
        switch (estado) {
            case AGREGAR:
                ...
                editor.establecerEstado(EstadoEdicion.AGREGAR);
                editor.setDato(new Canton());
                break;
            case MODIFICAR:

                editor.establecerEstado(EstadoEdicion.MODIFICAR);
                editor.setDato((Canton) dato);
                break;
            case ELIMINAR:
