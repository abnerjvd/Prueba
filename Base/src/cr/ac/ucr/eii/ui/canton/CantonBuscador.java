...
public class CantonBuscador extends javax.swing.JFrame {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        lista = administrador.buscar(null, txtNombre.getText());
    ...
    private void btnSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarActionPerformed
        ...
        if (n >= 0) {
            if (getReceptor() != null) {
                getReceptor().recibirResultadoBusqueda(lista.get(n), "Canton");
                dispose();
            }
        }
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        if (getReceptor() != null) {
            getReceptor().recibirResultadoBusqueda(null, "Canton");
        }
        dispose();
