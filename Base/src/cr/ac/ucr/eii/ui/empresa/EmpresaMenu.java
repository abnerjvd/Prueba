...
public class EmpresaMenu extends javax.swing.JFrame implements ReceptorBusqueda {
    ...
    private void initComponents() {
        ...
        setTitle("Mantenimientos de Empresas");
        setMinimumSize(null);
...
//        if (n == 0) {
            EmpresaEditor editor = new EmpresaEditor();
            editor.setVisible(true);
            editor.establecerEstado(EstadoEdicion.AGREGAR);
            Empresa x = new Empresa();
            x.setNombre("");
            x.setNumeroIdentificacion("");
            x.setTelefonoPrincipal("");
...
//                options[0]); //default button title
//        if (n == 0) {
            EmpresaBuscador buscador = new EmpresaBuscador();
    ...
    public void recibirResultadoBusqueda(IDato dato, String mensaje) {
        ...
        switch (estado) {
            case AGREGAR:
                ...
                editor.establecerEstado(EstadoEdicion.AGREGAR);
                editor.setDato(new Empresa());
                break;
            case MODIFICAR:

                editor.establecerEstado(EstadoEdicion.MODIFICAR);
                editor.setDato((Empresa) dato);
                break;
            case ELIMINAR:
