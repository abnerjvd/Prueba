 ...
 * under the License.
 */
package cr.ac.ucr.eii.ui.provincia;
...
public class ProvinciaMenu extends javax.swing.JFrame implements ReceptorBusqueda {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(750, 147));
        setUndecorated(true);
        setSize(new java.awt.Dimension(750, 200));

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(" Control de acciones del mantenimiento de países "));
...
//        if (n == 0) {
            ProvinciaEditor editor = new ProvinciaEditor();
...
//                options[0]); //default button title
//        if (n == 0) {
            ProvinciaBuscador buscador = new ProvinciaBuscador();
    ...
    public void recibirResultadoBusqueda(IDato dato, String mensaje) {
        ...
        switch (estado) {
            case AGREGAR:
                ...
                editor.establecerEstado(EstadoEdicion.AGREGAR);
                editor.setDato(new Provincia());
                break;
            case MODIFICAR:

                editor.establecerEstado(EstadoEdicion.MODIFICAR);
                editor.setDato((Provincia) dato);
                break;
            case ELIMINAR:
