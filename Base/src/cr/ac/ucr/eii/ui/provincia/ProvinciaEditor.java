...
public class ProvinciaEditor extends javax.swing.JFrame implements IControlEditor {
...
//        control.registrarVentana(this);
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ProvinciaAdministrador administrador = new ProvinciaAdministrador();
        cargarDatos();
        ...
        if (n == 0) {
            switch (estado) {
                case AGREGAR:
                    administrador.registrar(provincia);
                    break;
                case MODIFICAR:
                    administrador.actualizar(provincia);
                    break;
                case ELIMINAR:
                    administrador.eliminar(provincia);
                    break;
            }
        }
...
//        return control.obtenerEstado();
    ...
    public void setDato(Provincia provincia) {
